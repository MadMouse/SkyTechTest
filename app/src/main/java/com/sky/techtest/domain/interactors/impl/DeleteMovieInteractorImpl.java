...
public class DeleteMovieInteractorImpl extends AbstractInteractor implements AddMovieInteractor {
    ...
    public DeleteMovieInteractorImpl(Executor threadExecutor,
